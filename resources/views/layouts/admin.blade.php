...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <div class="font-sans-antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 dark md:w-64 dark:text-gray-200 dark-mode:bg-gray-800" x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-red focus:outline-none focus:shadow-outline">Flowtrail UI</a>
